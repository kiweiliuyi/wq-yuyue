...
class dayu_yuyuepayModule extends WeModule
{
	...
	public function settingsDisplay($settings)
	{
		global $_GPC, $_W;
		if (checksubmit()) {
			$data = array('title' => $_GPC['title'], 'list_num' => $_GPC['list_num'], 'subject' => $_GPC['subject'], 'smsid' => intval($_GPC['smsid']), 'otmpl' => $_GPC['otmpl'], 'qqkey' => $_GPC['qqkey'], 'stime' => intval($_GPC['stime']), 'etime' => intval($_GPC['etime']), 'notice' => intval($_GPC['notice']), 'today' => intval($_GPC['today']), 'paytime' => intval($_GPC['paytime']), 'paystate' => intval($_GPC['paystate']), 'newtemp' => intval($_GPC['newtemp']), 'role' => intval($_GPC['role']), 'pay' => intval($_GPC['pay']), 'store' => $_GPC['store'], 'color' => array('nav_index' => $_GPC['nav_index'], 'nav_page' => $_GPC['nav_page'], 'nav_btn' => $_GPC['nav_btn']), 'oauth' => $_GPC['oauth']);
